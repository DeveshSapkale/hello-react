...
const AppointmentInfo = ({appointment, onAppointmentDeleted}) =>{
    return(
        <li className="px-3 py-3 flex items-start">
              <button type="button"
                onClick={() => onAppointmentDeleted(appointment.id)}
              ...
              <div className="flex-grow">
                ...
                <div className="leading-tight">a{appointment.ptNotes}</div>
              </div>
            </li>
    );
}
